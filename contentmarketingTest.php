              ...
              <div class="jumbotron">
                  ...
                  <md-content layout-padding>
                       <div>
                            <md-input-container>
                                <label>Curated</label>
                                <input style="font-size:20px" name="curatedCnt" type="number" min="0">
                            </md-input-container>
                            <md-input-container>
                                <label>Drafted</label>
                                <input style="font-size:20px" name="draftedCnt" type="number" min="0">
                            </md-input-container>
                            <md-input-container>
                                <label>Pictures</label>
                                <input style="font-size:20px" name="pictureCnt" type="number" min="0">
                            </md-input-container>
                            <md-input-container>
                                <label>Videos</label>
                                <input style="font-size:20px" name="videoCnt" type="number" min="0">
                            </md-input-container>
                            <md-input-container>
