              ...
              <div class="jumbotron">
                  ...
                  <md-content layout-padding>
                       <div>
                            ...
                            <md-input-container>
                                <label>Reponsive</label>
                                <input style="font-size:20px" name="responsiveCnt" type="number" min="0">
                            </md-input-container>
                            <md-input-container>
                                <label>Backup</label>
                                <input style="font-size:20px" name="backupCnt" type="number" min="0">
                            </md-input-container>
                            <md-input-container>
                                <label>Optimize/Customize</label>
                                <input style="font-size:20px" name="optimizeCnt" type="number" min="0">
                            </md-input-container>
                            <md-input-container>
