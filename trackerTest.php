        ...
        <form action="#" method="GET">
          <div id="taskHolderOjt" class="container">
              <div class="jumbotron">
                  ...
                  <fieldset data-ng-repeat = "field in taskSet.tasks track by $index">
                      <div class="input-group">
                              <input type="text" class="inp form-control" placeholder="Task" name="taskList" ng-model="taskSet.tasks[$index]" required>
                  ...
                  <div class="footer" align="center">
                      <md-button ng-show="show" id="submitBtn" type="submit" class=" md-raised md-primary" ng-model="submitBtn">Submit</md-button>
                  </div>
              </div>
          </div>
        </form>
